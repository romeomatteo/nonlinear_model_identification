...
for (AR_deg,X_deg) in prod:
    ...
    directory =  "./FROE_plots_SEM2/AR_{}_X_{}/DEG_{}".format(AR_deg, X_deg, poly_degree)
    ...
    file_out = open("./FROE_plots_SEM2/AR_{}_X_{}/DEG_{}/model.txt".format(AR_deg, X_deg, poly_degree), 'w')
    file_out.write("y = \n")
    for i in range(len(regressor_selected)):
        if i == 0:
    ...
    plt.plot(y_id, color='red', label = "Process")
    plt.legend()
    plt.savefig("./FROE_plots_SEM2/AR_{}_X_{}/DEG_{}/plot_id.png".format(AR_deg, X_deg, poly_degree), transparent = False)
    plt.close()
    ...
    plt.plot(y_val, color='red', label = "Process")
    plt.legend()
    plt.savefig("./FROE_plots_SEM2/AR_{}_X_{}/DEG_{}/plot_val.png".format(AR_deg, X_deg, poly_degree), transparent = False)
    plt.close()
    ...
    plt.plot(y_val, color='red' , label = "Process")
    plt.legend()
    plt.savefig("./FROE_plots_SEM2/AR_{}_X_{}/DEG_{}/plot_sim.png".format(AR_deg, X_deg, poly_degree), transparent = False)
    plt.close()
    ...
    file_out = open("./FROE_plots_SEM2/AR_{}_X_{}/DEG_{}/mse.txt".format(AR_deg, X_deg, poly_degree), 'w')
